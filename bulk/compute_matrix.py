...
Usage:
  ...
  python bulk/compute_matrix.py --get be/statute/loi/1978/07/03/1978070303/article/52 --field model
...
def citation_slug(citation: str) -> str:
    ...
    be/statute/loi/1978/07/03/1978070303/article/52 -> uk-statute-ukpga-2003-1-681b
        ...
        out.append(
            {
                ...
                "repo": entry.get("repo", "rulespec-be"),
